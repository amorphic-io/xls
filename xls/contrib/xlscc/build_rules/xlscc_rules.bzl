...
def _xls_cc_ir_impl(ctx):
    ...
    default_include_dirs = [depset(ctx.attr._default_cc_header_files[XlsccIncludeInfo].include_dir)]

    include_dirs = depset(transitive = src_include_dirs + default_include_dirs)
    xlscc_include_dirs = []
    if "include_dirs" in xlscc_args:
        xlscc_include_dirs.append(xlscc_args.get("include_dirs"))
    xlscc_include_dirs += include_dirs.to_list()
    xlscc_include_dirs += [
        "${PWD}",
        "./",
    ...
    xlscc_args["include_dirs"] = ",".join(xlscc_include_dirs)
...
_xls_cc_ir_attrs = {
    ...
    "_default_cc_header_files": attr.label(
        ...
        default = Label("//xls/contrib/xlscc:ac_headers_stub"),
        cfg = "target",
    ),
